function(qmapvina_location_setup_plugins target)
    string(TOUPPER "${CMAKE_BUILD_TYPE}" _BuildConfiguration)
    get_target_property(_ImportedConfigurations QMapVina::PluginGeoServices IMPORTED_CONFIGURATIONS)
    ...
    get_target_property(_ImportedLocationGeoServices QMapVina::PluginGeoServices IMPORTED_LOCATION_${_Configuration})
    get_filename_component(_ImportedLocationPathGeoServices ${_ImportedLocationGeoServices} DIRECTORY)

    get_target_property(_ImportedLocationQml QMapVina::PluginQmlLocation IMPORTED_LOCATION_${_Configuration})
    ...
    get_target_property(_targetTypeCore QMapVina::Core TYPE)
    if(_targetTypeCore STREQUAL STATIC_LIBRARY)
        target_link_libraries(
            ${target}
            PRIVATE
                QMapVina::PluginGeoServices
                QMapVina::PluginQmlLocation
        )
        return()
    endif()
