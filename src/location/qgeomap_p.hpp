...
class QGeoMapMapVinaPrivate : public QGeoMapPrivate {
    Q_DECLARE_PUBLIC(QGeoMapMapVina)

public:
    explicit QGeoMapMapVinaPrivate(QGeoMappingManagerEngine *engine);
    ~QGeoMapMapVinaPrivate() override;
...
private:
    Q_DISABLE_COPY(QGeoMapMapVinaPrivate);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(QGeoMapMapVinaPrivate::SyncStates)
