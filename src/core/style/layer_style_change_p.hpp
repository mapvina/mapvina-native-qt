...
class Q_MAPVINA_CORE_EXPORT StyleAddLayer : public StyleChange {
public:
...
class Q_MAPVINA_CORE_EXPORT StyleRemoveLayer : public StyleChange {
public:
...
class Q_MAPVINA_CORE_EXPORT StyleSetLayoutProperties : public StyleChange {
public:
...
class Q_MAPVINA_CORE_EXPORT StyleSetPaintProperties : public StyleChange {
public:
...
class Q_MAPVINA_CORE_EXPORT StyleSetFilter : public StyleChange {
public:
