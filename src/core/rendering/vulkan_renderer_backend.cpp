...
public:
    QtVulkanRenderableResource(QMapVina::VulkanRendererBackend &backend_, mbgl::Size initialSize)
    ...
    void bind() override {
        ...
        if (externalImage) {
            ...
            // IMPORTANT: MapVina will call getFramebuffer() and getRenderPass() after this bind()
            ...
            // will be used by MapVina's RenderPass when it calls resource.getFramebuffer()
    ...
    void swap() override {
        ...
        if (externalImage) {
            ...
            // Submit the frame - this should contain all the MapVina rendering commands
            context.submitFrame();
...
private:
    ...
    QMapVina::VulkanRendererBackend &backend;
