...
// mbgl::FeatureType
static_assert(mbgl::underlying_type(QMapVina::Feature::PointType) == mbgl::underlying_type(mbgl::FeatureType::Point),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Feature::LineStringType) ==
                  mbgl::underlying_type(mbgl::FeatureType::LineString),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Feature::PolygonType) ==
...
/*!
    ...
    Contains miscellaneous MapVina types and utilities used throughout MapVina Qt bindings.
*/
...
/*!
    ...
    \headerfile types.hpp <QMapVina/Types>
