...
// mbgl::GLContextMode
static_assert(mbgl::underlying_type(QMapVina::Settings::UniqueGLContext) ==
                  mbgl::underlying_type(mbgl::gfx::ContextMode::Unique),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Settings::SharedGLContext) ==
                  mbgl::underlying_type(mbgl::gfx::ContextMode::Shared),
              "error");

// mbgl::MapMode
static_assert(mbgl::underlying_type(QMapVina::Settings::Continuous) ==
                  mbgl::underlying_type(mbgl::MapMode::Continuous),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Settings::Static) == mbgl::underlying_type(mbgl::MapMode::Static),
              "error");

// mbgl::ConstrainMode
static_assert(mbgl::underlying_type(QMapVina::Settings::NoConstrain) ==
                  mbgl::underlying_type(mbgl::ConstrainMode::None),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Settings::ConstrainHeightOnly) ==
                  mbgl::underlying_type(mbgl::ConstrainMode::HeightOnly),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Settings::ConstrainWidthAndHeight) ==
                  mbgl::underlying_type(mbgl::ConstrainMode::WidthAndHeight),
              "error");

// mbgl::ViewportMode
static_assert(mbgl::underlying_type(QMapVina::Settings::DefaultViewport) ==
                  mbgl::underlying_type(mbgl::ViewportMode::Default),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Settings::FlippedYViewport) ==
...
/*!
    ...
    \headerfile settings.hpp <QMapVina/Settings>
...
*/
/*!
    \var Settings::MapVinaProvider
    The template for MapVina-hosted vector tiles and styles.
*/
/*!
...
/*!
    ...
    <a href="https://github.io/github/mapvina/mapvina-native/blob/main/bin/offline.sh">
    Offline Tool</a>.
...
/*!
    ...
    MapVina can support servers with different resource path structure.
...
void SettingsPrivate::setProviderTemplate(Settings::ProviderTemplate providerTemplate) {
    ...
    if (providerTemplate == Settings::MapVinaProvider) {
        m_tileServerOptions = mbgl::TileServerOptions::MapVinaConfiguration();
