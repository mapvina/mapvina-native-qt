...
/*!
    \defgroup QMapVina QMapVina Core
    \brief Core types and utilities used throughout MapVina Qt bindings.
*/

// mbgl::NetworkStatus::Status
static_assert(mbgl::underlying_type(QMapVina::Online) == mbgl::underlying_type(mbgl::NetworkStatus::Status::Online),
              "error");
static_assert(mbgl::underlying_type(QMapVina::Offline) == mbgl::underlying_type(mbgl::NetworkStatus::Status::Offline),
              "error");
...
/*!
    ...
    This enum represents possible renderer types used by MapVina Qt bindings.
*/
/*!
    \var OpenGL
...
/*!
    Forwards the network status \a mode to MapVina Native engine.
