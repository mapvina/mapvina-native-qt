...
#ifndef QMAPVINA_TYPES_H
#define QMAPVINA_TYPES_H
...
struct Q_MAPVINA_CORE_EXPORT Style {
...
struct Q_MAPVINA_CORE_EXPORT Feature {
    enum Type {
        PointType = 1,
        LineStringType,
        PolygonType
...
struct Q_MAPVINA_CORE_EXPORT FeatureProperty {
    enum Type {
        LayoutProperty = 1,
        PaintProperty,
    };
...
struct Q_MAPVINA_CORE_EXPORT ShapeAnnotationGeometry {
    enum Type {
        LineStringType = 1,
        PolygonType,
        MultiLineStringType,
...
struct Q_MAPVINA_CORE_EXPORT SymbolAnnotation {
    Coordinate geometry;
    QString icon;
};

struct Q_MAPVINA_CORE_EXPORT LineAnnotation {
    /*! Class constructor. */
...
struct Q_MAPVINA_CORE_EXPORT FillAnnotation {
    /*! Class constructor. */
...
struct Q_MAPVINA_CORE_EXPORT CameraOptions {
...
struct Q_MAPVINA_CORE_EXPORT AnimationOptions {
...
struct Q_MAPVINA_CORE_EXPORT CustomLayerRenderParameters {
    double width;
    double height;
    double latitude;
    double longitude;
...
class Q_MAPVINA_CORE_EXPORT CustomLayerHostInterface {
public:
...
Q_DECLARE_METATYPE(QMapVina::Coordinate);
Q_DECLARE_METATYPE(QMapVina::Coordinates);
Q_DECLARE_METATYPE(QMapVina::CoordinatesCollection);
Q_DECLARE_METATYPE(QMapVina::CoordinatesCollections);
Q_DECLARE_METATYPE(QMapVina::Feature);

Q_DECLARE_METATYPE(QMapVina::SymbolAnnotation);
Q_DECLARE_METATYPE(QMapVina::ShapeAnnotationGeometry);
Q_DECLARE_METATYPE(QMapVina::LineAnnotation);
Q_DECLARE_METATYPE(QMapVina::FillAnnotation);

#endif // QMAPVINA_TYPES_H
