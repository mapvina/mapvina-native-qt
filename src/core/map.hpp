...
#ifndef QMAPVINA_MAP_H
#define QMAPVINA_MAP_H
...
class Q_MAPVINA_CORE_EXPORT Map : public QObject {
    Q_OBJECT
    ...
    Q_PROPERTY(QMapVina::Coordinate coordinate READ coordinate WRITE setCoordinate)
...
Q_DECLARE_METATYPE(QMapVina::Map::MapChange);
Q_DECLARE_METATYPE(QMapVina::Map::MapLoadingFailure);

#endif // QMAPVINA_MAP_H
