...
/*!
    ...
    \brief A QML type for setting parameters of a source. Generated from \ref QMapVina::SourceParameter and should be nested in a \ref Style.
    \ingroup QMapVinaLocation
