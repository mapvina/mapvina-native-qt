...
class MLNDocumentationExampleTests: XCTestCase, MLNMapViewDelegate {
    ...
    func testMLNRasterDEMSource() {
        ...
        class MLNRasterDEMSource: MapVina.MLNRasterDEMSource {
    ...
    func testMLNImageSource() {
        ...
        let source = MLNImageSource(identifier: "radar", coordinateQuad: coordinates, url: URL(string: "https://mapvina.com/mapvina-gl-js-docs/assets/radar.gif")!)
        mapView.style?.addSource(source)
        // #-end-example-code
    ...
    func testMLNMapSnapshotter() throws {
        throw XCTSkip("Snapshotter not implemented yet for Metal. See https://github.com/mapvina/mapvina-native/issues/1862")
