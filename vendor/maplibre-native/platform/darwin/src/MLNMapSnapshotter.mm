...
#if TARGET_OS_IPHONE
            logoImage = [UIImage imageNamed:@"mapvina-logo-icon" inBundle:[NSBundle mgl_frameworkBundle] compatibleWithTraitCollection:nil];
#else
...
+ (MLNImage *)mapvinaLongStyleLogo
{
    MLNImage *logoImage;
#if TARGET_OS_IPHONE
    logoImage =[UIImage imageNamed:@"mapvina-logo-stroke-gray" inBundle:[NSBundle mgl_frameworkBundle] compatibleWithTraitCollection:nil];
#else
