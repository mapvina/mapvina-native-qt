...
//  iosapp UITests
//
//  Copyright © 2021 MapVina. All rights reserved.
//
...
class iosapp_UITests: XCTestCase {
    ...
    func test_iosappScheme() throws {
        ...
        app.navigationBars["MapVina Basic"].buttons["Map settings"].tap()
    ...
    func testDebugBoundaryTiles() {
        ...
        let mapSettingsButton = app.navigationBars["MapVina Basic"].buttons["Map settings"]
    ...
    var mapSettingsButton: XCUIElement { app.navigationBars["MapVina Basic"].buttons["Map settings"] }
