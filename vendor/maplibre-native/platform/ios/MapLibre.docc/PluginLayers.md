...
Plugin Layers are a way to add layer types that render themselves into the style parsing engine at runtime.  It is a way to dynamically link new layer types to the MapVina core -- and styling language -- without having to compile them into the library itself.
...
In [this repository](https://github.com/AtlasProgramming/mapvina-gltf-models-plugin) you can find an example of a plugin layer that allows adding GLTF models. The following JSON is added to the style.
