...
import com.mapvina.android.testapp.activity.style.FillExtrusionStyleTestActivity;
...
import static com.mapvina.android.style.layers.Property.ANCHOR_MAP;
import static com.mapvina.android.style.layers.PropertyFactory.fillExtrusionBase;
import static com.mapvina.android.style.layers.PropertyFactory.fillExtrusionColor;
import static com.mapvina.android.style.layers.PropertyFactory.fillExtrusionHeight;
import static com.mapvina.android.style.layers.PropertyFactory.fillExtrusionOpacity;
  ...
  private void setupLight() {
    onView(withId(R.id.mapView)).perform(new ViewAction() {
      ...
      public void perform(UiController uiController, View view) {
        light = mapvinaMap.getStyle().getLight();
        ...
        mapvinaMap.getStyle().addLayer(fillExtrusionLayer);
      }
    });
  }
