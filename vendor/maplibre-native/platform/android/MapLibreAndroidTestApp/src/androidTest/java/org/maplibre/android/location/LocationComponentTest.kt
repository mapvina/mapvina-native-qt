...
class LocationComponentTest : EspressoTest() {
    ...
    override fun validateTestSetup() {
        ...
        assertThat(mapvinaMap.style, notNullValue())
    }
    ...
    fun locationComponent_doesntShowUntilFirstLocationFix() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertThat(mapvinaMap.queryRenderedFeatures(location, FOREGROUND_LAYER).isEmpty(), `is`(false))
            }
        }
        executeComponentTest(componentAction)
    }
    ...
    fun locationComponentOptions_disablingStaleStateDoesWorkCorrectly() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                mapvinaMap.querySourceFeatures(LOCATION_SOURCE).also { feature ->
                    feature.forEach {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                foregroundDrawable?.let {
                    mapvinaMap.addImageFromDrawable("custom-foreground-bitmap", it)
                    mapvinaMap.addImageFromDrawable("custom-background-bitmap", it)
                    mapvinaMap.addImageFromDrawable("custom-foreground-stale-bitmap", it)
                    mapvinaMap.addImageFromDrawable("custom-background-stale-bitmap", it)
                    mapvinaMap.addImageFromDrawable("custom-bearing-bitmap", it)
                }

                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                val feature = mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0]
    ...
    fun locationComponentOptions_loadsGpsNameWithGpsRenderMode() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                foregroundDrawable?.let {
                    mapvinaMap.addImageFromDrawable("custom-foreground-bitmap", it)
                    mapvinaMap.addImageFromDrawable("custom-gps-bitmap", it)
                }
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                val foregroundId = mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].getStringProperty(PROPERTY_FOREGROUND_ICON)
    ...
    fun locationComponentOptions_customIconNameRevertsToDefault() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(FOREGROUND_ICON, mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].getStringProperty(PROPERTY_FOREGROUND_ICON))
            }
        }
    ...
    fun stillStaleAfterResuming() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertThat(mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].getBooleanProperty(PROPERTY_LOCATION_STALE), `is`(true))
    ...
    fun stillNotStaleAfterResuming() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertThat(mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].getBooleanProperty(PROPERTY_LOCATION_STALE), `is`(false))
    ...
    fun forceLocationUpdate_doesMoveLocationLayerIconToCorrectPosition() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val point: Point = mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].geometry() as Point
    ...
    fun disablingComponentHidesPuck() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val point: Point = mapvinaMap.queryRenderedFeatures(location, FOREGROUND_LAYER)[0].geometry() as Point
                assertEquals(point.latitude(), location.latitude, 0.1)
                assertEquals(point.longitude(), location.longitude, 0.1)
    ...
    fun lifecycle_forceLocationUpdateAfterStopped() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertThat(mapvinaMap.querySourceFeatures(LOCATION_SOURCE).isEmpty(), `is`(true))
            }
        }
        executeComponentTest(componentAction)
    }
    ...
    fun animators_layerBearingCorrect() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(77f, mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].getNumberProperty(PROPERTY_GPS_BEARING).toFloat(), 0.1f)

                location.bearing = 92f
                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                uiController.loopMainThreadForAtLeast(MAX_ANIMATION_DURATION_MS) // Waiting for the animation to finish
                assertEquals(92.0f, mapvinaMap.querySourceFeatures(LOCATION_SOURCE)[0].getNumberProperty(PROPERTY_GPS_BEARING).toFloat(), 0.5f)
            }
        }
    ...
    fun animators_cameraLatLngBearingCorrect() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(77.0, mapvinaMap.cameraPosition.bearing, 0.1)
                assertEquals(location.latitude, mapvinaMap.cameraPosition.target!!.latitude, 0.1)
                assertEquals(location.longitude, mapvinaMap.cameraPosition.target!!.longitude, 0.1)
                ...
                assertEquals(92.0, mapvinaMap.cameraPosition.bearing, 0.1)
                assertEquals(location.latitude, mapvinaMap.cameraPosition.target!!.latitude, 0.1)
                assertEquals(location.longitude, mapvinaMap.cameraPosition.target!!.longitude, 0.1)
            }
        }
    ...
    fun animators_cameraBearingCorrect() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val latitude = mapvinaMap.cameraPosition.target!!.latitude
                val longitude = mapvinaMap.cameraPosition.target!!.longitude
                ...
                assertEquals(77.0, mapvinaMap.cameraPosition.bearing, 0.1)
                assertEquals(latitude, mapvinaMap.cameraPosition.target!!.latitude, 0.1)
                assertEquals(longitude, mapvinaMap.cameraPosition.target!!.longitude, 0.1)
    ...
    fun animators_cameraNoneCorrect() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val latitude = mapvinaMap.cameraPosition.target!!.latitude
                val longitude = mapvinaMap.cameraPosition.target!!.longitude
                val bearing = mapvinaMap.cameraPosition.bearing
                ...
                assertEquals(bearing, mapvinaMap.cameraPosition.bearing, 0.1)
                assertEquals(latitude, mapvinaMap.cameraPosition.target!!.latitude, 0.1)
                assertEquals(longitude, mapvinaMap.cameraPosition.target!!.longitude, 0.1)
    ...
    fun animators_focalPointAdjustment() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertThat(mapvinaMap.uiSettings.focalPoint, nullValue())
            }
        }
    ...
    fun animators_zoomWhileTracking() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(10.0, mapvinaMap.cameraPosition.zoom, 0.1)
            }
        }
    ...
    fun animators_zoomWhileTrackingCanceledOnModeChange() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(15.0 / 2.0, mapvinaMap.cameraPosition.zoom, 3.0)
            }
        }
    ...
    fun animators_dontZoomWhileTransitioning() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(zoom, mapvinaMap.cameraPosition.zoom, 0.0001)
            }
        }
    ...
    fun animators_tiltWhileTracking() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(30.0, mapvinaMap.cameraPosition.tilt, 0.1)
            }
        }
    ...
    fun animators_tiltWhileTrackingCanceledOnModeChange() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(30.0 / 2.0, mapvinaMap.cameraPosition.tilt, 3.0)
            }
        }
    ...
    fun animators_dontTiltWhileTransitioning() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertEquals(tilt, mapvinaMap.cameraPosition.tilt, 0.0001)
            }
        }
    ...
    fun animators_dontPaddingWhileNotTracking() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.cameraMode = CameraMode.NONE
                val padding = mapvinaMap.cameraPosition.padding
                ...
                assertArrayEquals(padding, mapvinaMap.cameraPosition.padding, 0.1)
            }
        }
    ...
    fun animators_paddingWhileTracking() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                assertArrayEquals(padding, mapvinaMap.cameraPosition.padding, 0.01)
            }
        }
    ...
    fun cameraPositionAdjustedToTrackingModeWhenComponentEnabled() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.forceLocationUpdate(location)
                component.isLocationComponentEnabled = false
                mapvinaMap.moveCamera(CameraUpdateFactory.newLatLng(LatLng(51.0, 17.0)))
                mapvinaMap.moveCamera(CameraUpdateFactory.bearingTo(90.0))
                component.isLocationComponentEnabled = true
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                uiController.loopMainThreadForAtLeast(MAX_ANIMATION_DURATION_MS)

                assertEquals(location.bearing.toDouble(), mapvinaMap.cameraPosition.bearing, 0.1)
                assertEquals(location.latitude, mapvinaMap.cameraPosition.target!!.latitude, 0.1)
                assertEquals(location.longitude, mapvinaMap.cameraPosition.target!!.longitude, 0.1)
            }
        }
    ...
    fun cameraPositionSnappedToTargetIfExceedsThreshold() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                mapvinaMap.moveCamera(CameraUpdateFactory.newLatLng(target))
                mapvinaMap.moveCamera(CameraUpdateFactory.zoomTo(15.0))
                mapvinaMap.moveCamera(CameraUpdateFactory.bearingTo(90.0))
                assertTrue(Utils.immediateAnimation(mapvinaMap.projection, mapvinaMap.cameraPosition.target!!, LatLng(location)))
    ...
    private fun executeComponentTest(listener: LocationComponentAction.OnPerformLocationComponentAction) {
        onView(withId(R.id.content)).perform(LocationComponentAction(mapvinaMap, listener))
    }
}
