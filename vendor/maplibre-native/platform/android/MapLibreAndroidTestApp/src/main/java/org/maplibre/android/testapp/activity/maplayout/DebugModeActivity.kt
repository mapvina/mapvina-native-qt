...
import com.mapvina.android.maps.MapVinaMap.OnFpsChangedListener
...
open class DebugModeActivity : AppCompatActivity(), OnMapReadyCallback, OnFpsChangedListener {
    ...
    private fun setupMapView(savedInstanceState: Bundle?) {
        val mapvinaMapOptions = setupMapVinaMapOptions()
        ...
        mapView.addOnDidFinishLoadingStyleListener {
            if (this::mapvinaMap.isInitialized) {
                setupNavigationView(mapvinaMap.style!!.layers)
            }
        }
        mapView.tag = true
    ...
    protected open fun setupMapVinaMapOptions(): MapVinaMapOptions {
        return MapVinaMapOptions.createFromAttributes(this, null)
    }
    ...
    private fun setFpsView() {
        ...
        mapvinaMap.setOnFpsChangedListener(this)
    }
    ...
    private fun setupNavigationView(layerList: List<Layer>) {
        Timber.v("New style loaded with JSON: %s", mapvinaMap.style!!.json)
        ...
        mapvinaMap.addOnCameraMoveListener(
            OnCameraMoveListener {
                textView.text = String.format(
                    ...
                    mapvinaMap.cameraPosition.zoom
                )
    ...
    private fun setupDebugChangeView() {
        ...
        fabDebug.setOnClickListener { view: View? ->
            if (this::mapvinaMap.isInitialized) {
                mapvinaMap.isDebugActive = !mapvinaMap.isDebugActive
                Timber.d("Debug FAB: isDebug Active? %s", mapvinaMap.isDebugActive)
            }
        }
    }
    ...
    private fun setupStyleChangeView() {
        ...
        fabStyles.setOnClickListener { view: View? ->
            if (this::mapvinaMap.isInitialized) {
                ...
                mapvinaMap.setStyle(Style.Builder().fromUri(STYLES[currentStyleIndex]))
            }
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (itemId == R.id.menu_action_toggle_report_fps) {
            ...
            mapvinaMap.setOnFpsChangedListener(if (isReportFps) this else null)
