...
class UserMap : SupportMapFragment() {
    ...
    companion object {
        ...
        // true -> use all bitmap drawables in `com.mapvina.android.R.drawable.*`
        ...
        private val ICONS = arrayListOf(
            ...
            com.mapvina.android.R.drawable.mapvina_user_icon,
            com.mapvina.android.R.drawable.mapvina_marker_icon_default,
            com.mapvina.android.R.drawable.mapvina_compass_icon,
            com.mapvina.android.R.drawable.mapvina_user_puck_icon,
        )
        ...
        private fun randomLatLng(map: MapVinaMap): LatLng =
    ...
    private fun run() {
        if (USE_ALL_DRAWABLES) {
            bitmapDrawables =
                com.mapvina.android.R.drawable::class.java.fields.map { field: Field ->
