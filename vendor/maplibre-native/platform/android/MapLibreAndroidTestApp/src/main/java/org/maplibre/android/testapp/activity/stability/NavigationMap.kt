package com.mapvina.android.testapp.activity.stability
...
import com.mapvina.android.testapp.activity.stability.LongRunningActivity.Companion.printStats
import com.mapvina.android.testapp.styles.TestStyles
import com.mapvina.android.testapp.utils.GeoParseUtil
import com.mapvina.android.testapp.utils.setStyleSuspend
import com.mapvina.geojson.Point
import com.mapvina.navigation.android.navigation.v5.location.replay.ReplayRouteLocationEngine
import com.mapvina.navigation.android.navigation.v5.milestone.BannerInstructionMilestone
import com.mapvina.navigation.android.navigation.v5.milestone.Milestone
import com.mapvina.navigation.android.navigation.v5.milestone.MilestoneEventListener
import com.mapvina.navigation.android.navigation.v5.models.DirectionsResponse
import com.mapvina.navigation.android.navigation.v5.models.DirectionsRoute
import com.mapvina.navigation.android.navigation.v5.models.RouteOptions
import com.mapvina.navigation.android.navigation.v5.navigation.MapVinaNavigation
import com.mapvina.navigation.android.navigation.v5.navigation.MapVinaNavigationOptions
import com.mapvina.navigation.android.navigation.v5.navigation.NavigationMapRoute
import com.mapvina.navigation.android.navigation.v5.routeprogress.ProgressChangeListener
import com.mapvina.navigation.android.navigation.v5.routeprogress.RouteProgress
import java.util.Locale
import java.util.logging.Logger
import kotlin.random.Random

class NavigationMap : SupportMapFragment(), ProgressChangeListener, MilestoneEventListener {
    private lateinit var map: MapVinaMap
    ...
    private fun run() {
        lifecycleScope.launch {
            ...
            navigation = MapVinaNavigation(requireContext(), MapVinaNavigationOptions
                .builder()
                .snapToRoute(true)
                .build()
            ).apply {
    ...
    private fun getRoute(): DirectionsRoute? {
        ...
        val routeString: String? = when (ROUTE_PROVIDER) {
            ...
            RouteProvider.OSRM -> {
                ...
                val request = Request
                    .Builder()
                    .header("User-Agent", "MapVina Android")
