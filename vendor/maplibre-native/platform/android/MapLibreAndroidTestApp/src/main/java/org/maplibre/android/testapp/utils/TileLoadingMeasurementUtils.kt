    ...
    companion object {
        ...
        private val isTileLoadingMeasurementOn: Boolean
            get() = isBooleanMetaDataValueOn(
                MapVinaConstants.KEY_META_DATA_MEASURE_TILE_DOWNLOAD_ON,
                MapVinaConstants.DEFAULT_MEASURE_TILE_DOWNLOAD_ON
            )

        private fun isBooleanMetaDataValueOn(propKey: String, defaultValue: Boolean): Boolean {
            try {
                // Try getting a custom value from the app Manifest
                val context = MapVina.getApplicationContext()
        ...
        internal class TileLoadingInterceptor : Interceptor {
            ...
            companion object {
                ...
                private val ram: String
                    get() {
                        val actManager = MapVina.getApplicationContext()
                ...
                private val windowSize: String
                    get() {
                        val metrics = MapVina.getApplicationContext().resources.displayMetrics
                ...
                private val connectionState: String
                    get() {
                        val appContext = MapVina.getApplicationContext()
