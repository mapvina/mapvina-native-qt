package com.mapvina.android.testapp.activity.turf

import android.graphics.Color
import android.os.Bundle
import android.os.PersistableBundle
import androidx.appcompat.app.AppCompatActivity
import com.mapvina.geojson.*
...
import com.mapvina.android.style.expressions.Expression.within
...
import com.mapvina.android.style.layers.Property.NONE
...
import com.mapvina.android.testapp.databinding.ActivityMapsnapshotterWithinExpressionBinding
import com.mapvina.android.testapp.styles.TestStyles.getPredefinedStyleWithFallback
...
class MapSnapshotterWithinExpression : AppCompatActivity() {
    ...
    private val cameraListener = object : MapView.OnCameraDidChangeListener {
        override fun onCameraDidChange(animated: Boolean) {
            if (!snapshotInProgress) {
                ...
                snapshotter.setCameraPosition(mapvinaMap.cameraPosition)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mapView.getMapAsync { map ->
            ...
            mapvinaMap.cameraPosition = CameraPosition.Builder().target(LatLng(38.90628988399711, -77.06574689337494)).zoom(15.5).build()
    ...
    private fun setupStyle() {
        ...
        val options = MapSnapshotter.Options(binding.imageView.measuredWidth / 2, binding.imageView.measuredHeight / 2)
            .withCameraPosition(mapvinaMap.cameraPosition)
