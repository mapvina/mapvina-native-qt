...
import com.mapvina.android.maps.MapVinaMap.OnMoveListener
import com.mapvina.android.maps.MapVinaMap.OnRotateListener
import com.mapvina.android.maps.MapVinaMap.OnScaleListener
import com.mapvina.android.maps.MapVinaMap.OnShoveListener
...
import com.mapvina.android.testapp.utils.FontCache
...
class GestureDetectorActivity : AppCompatActivity() {
    ...
    private fun initializeMap() {
        gesturesManager = mapvinaMap.gesturesManager
        ...
        attachListeners()
        fixedFocalPointEnabled(mapvinaMap.uiSettings.focalPoint != null)
    }
    ...
    fun attachListeners() {
        ...
        mapvinaMap.addOnRotateListener(
    ...
    private fun fixedFocalPointEnabled(enabled: Boolean) {
        if (enabled) {
            ...
            marker = mapvinaMap.addMarker(MarkerOptions().position(focalPointLatLng))
            ...
            mapvinaMap.uiSettings.focalPoint = null
        }
    }

    private fun recalculateFocalPoint() {
        if (focalPointLatLng != null) {
            mapvinaMap.uiSettings.focalPoint =
                mapvinaMap.projection.toScreenLocation(focalPointLatLng!!)
        }
    }
