...
class BottomSheetActivity : AppCompatActivity() {
    ...
    class MainMapFragment : Fragment(), OnMapReadyCallback {
        ...
        companion object {
            ...
            fun newInstance(context: Context?, mapCounter: Int): MainMapFragment {
                ...
                val mapvinaMapOptions = MapVinaMapOptions.createFromAttributes(context!!)
                mapFragment.arguments = MapFragmentUtils.createFragmentArgs(mapvinaMapOptions)
                return mapFragment
            }
        }
    }
    ...
    class BottomSheetFragment : Fragment(), OnMapReadyCallback {
        ...
        override fun onMapReady(mapvinaMap: MapVinaMap) {
            ...
            mapvinaMap.setStyle(TestStyles.getPredefinedStyleWithFallback("Bright"))
        }
        ...
        companion object {
            fun newInstance(context: Context?): BottomSheetFragment {
                ...
                val mapvinaMapOptions = MapVinaMapOptions.createFromAttributes(context!!)
                mapvinaMapOptions.renderSurfaceOnTop(true)
                mapFragment.arguments = MapFragmentUtils.createFragmentArgs(mapvinaMapOptions)
                return mapFragment
            }
        }
