...
class QueryRenderedFeaturesPropertiesActivity : AppCompatActivity() {
    ...
    private val mapClickListener = OnMapClickListener { point ->
        ...
        val pixel = mapvinaMap.projection.toScreenLocation(point)
        Timber.i(
        ...
        val features = mapvinaMap.queryRenderedFeatures(pixel)
        ...
        marker = mapvinaMap.addMarker(CustomMarkerOptions().position(point)!!.features(features))
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { mapvinaMap: MapVinaMap ->
            mapvinaMap.setStyle(TestStyles.getPredefinedStyleWithFallback("Streets")) { style: Style? ->
                this@QueryRenderedFeaturesPropertiesActivity.mapvinaMap = mapvinaMap
