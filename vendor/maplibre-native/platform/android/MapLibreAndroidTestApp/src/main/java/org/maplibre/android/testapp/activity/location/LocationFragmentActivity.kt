...
import com.mapvina.android.testapp.databinding.ActivityLocationLayerFragmentBinding
...
class LocationFragmentActivity : AppCompatActivity() {
    ...
    class LocationFragment : Fragment(), LocationEngineCallback<LocationEngineResult> {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            mapView.getMapAsync {
                ...
                it.setStyle(TestStyles.getPredefinedStyleWithFallback("Streets")) { style ->
                    val component = mapvinaMap.locationComponent
        ...
        override fun onSuccess(result: LocationEngineResult?) {
            if (!mapView.isDestroyed) mapvinaMap.animateCamera(CameraUpdateFactory.newLatLngZoom(LatLng(result?.lastLocation!!), 12.0))
        }
