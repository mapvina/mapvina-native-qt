...
class CircleLayerActivity : AppCompatActivity(), View.OnClickListener {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { map: MapVinaMap? ->
            ...
            mapvinaMap.setStyle(TestStyles.PROTOMAPS_WHITE) {
    ...
    private fun removeOldSource() {
        mapvinaMap.style!!.removeSource(SOURCE_ID)
        mapvinaMap.style!!.removeLayer(LAYER_ID)
    }
    ...
    private fun removeBusStop() {
        mapvinaMap.style!!.removeLayer(layer!!)
        mapvinaMap.style!!.removeSource(source!!)
    }

    private fun loadNewStyle() {
        mapvinaMap.setStyle(Style.Builder().fromUri(nextStyle))
    }
    ...
    companion object {
        ...
        const val URL_BUS_ROUTES =
            "https://s3.eu-central-1.amazonaws.com/mapvina-native/android-documentation-resources/bus-stops.geojson"
