...
import com.mapvina.android.testapp.databinding.ActivityCollectionUpdateOnStyleChangeBinding
...
class CollectionUpdateOnStyleChange : AppCompatActivity(), OnMapReadyCallback, Style.OnStyleLoaded {
    ...
    override fun onMapReady(map: MapVinaMap) {
        mapvinaMap = map
        mapvinaMap.setStyle(Style.Builder().fromUri(STYLES[currentStyleIndex]), this)
    }
