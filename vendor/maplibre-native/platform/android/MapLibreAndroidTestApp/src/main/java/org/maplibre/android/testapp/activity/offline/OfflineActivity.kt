package com.mapvina.android.testapp.activity.offline
...
import com.mapvina.android.offline.OfflineManager.CreateOfflineRegionCallback
import com.mapvina.android.offline.OfflineManager.ListOfflineRegionsCallback
import com.mapvina.android.offline.OfflineRegion
import com.mapvina.android.offline.OfflineRegion.OfflineRegionObserver
...
import com.mapvina.android.testapp.model.other.OfflineDownloadRegionDialog
import com.mapvina.android.testapp.model.other.OfflineDownloadRegionDialog.DownloadRegionDialogListener
import com.mapvina.android.testapp.model.other.OfflineListRegionsDialog
import com.mapvina.android.testapp.styles.TestStyles
import com.mapvina.android.testapp.utils.OfflineUtils
...
class OfflineActivity : AppCompatActivity(), DownloadRegionDialogListener {
   ...
   */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // You can use MapVina.setConnected(Boolean) to manually set the connectivity
        // state of your app. This will override any checks performed via the ConnectivityManager.
        // MapVina.getInstance().setConnected(false);
        val connected = MapVina.isConnected()
        Timber.d("MapVina is connected: %s", connected)
        ...
        mapView.getMapAsync { mapvinaMap: MapVinaMap ->
            ...
            this@OfflineActivity.mapvinaMap = mapvinaMap
            mapvinaMap.setStyle(Style.Builder().fromUri(STYLE_URL))
   ...
   */
    override fun onDownloadRegionDialogPositiveClick(regionName: String?) {
        ...
        // Definition
        val bounds = mapvinaMap.projection.visibleRegion.latLngBounds
        val minZoom = mapvinaMap.cameraPosition.zoom
        val maxZoom = mapvinaMap.maxZoomLevel
    ...
    private fun launchDownload() {
        ...
        offlineRegion!!.setObserver(object : OfflineRegionObserver {
            ...
            override fun mapboxTileCountLimitExceeded(limit: Long) {
                Timber.e("MapVina tile count limit exceeded: %s", limit)
                offlineRegion!!.setDownloadState(OfflineRegion.STATE_INACTIVE)
            }
        })
