package com.mapvina.android.testapp.activity.events
...
class ObserverActivity : AppCompatActivity(),
    ...
    private fun printActionJournal(map: MapVinaMap) {
        // configure using `MapVinaMapOptions.actionJournal*` methods
