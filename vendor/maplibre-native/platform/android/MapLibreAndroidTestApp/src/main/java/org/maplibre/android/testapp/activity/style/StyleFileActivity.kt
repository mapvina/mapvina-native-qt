...
/**
 * Test activity showcasing how to use a file:// resource for the style.json and how to use MapVinaMap#setStyleJson.
 */
                ...
                fabStyleJson.setOnClickListener { view: View ->
                    lifecycleScope.launch(Dispatchers.IO) {
                        ...
                        withContext(Dispatchers.Main) {
                            ...
                            mapvinaMap.setStyle(Style.Builder().fromJson(json))
                        }
                    }
                }
            }
