...
class TextureViewTransparentBackgroundActivity : AppCompatActivity() {
    ...
    private val mapvinaMap: MapVinaMap? = null
    ...
    private fun setupMapView(savedInstanceState: Bundle?) {
        val mapvinaMapOptions = MapVinaMapOptions.createFromAttributes(this, null)
        mapvinaMapOptions.translucentTextureSurface(true)
        ...
        mapView.getMapAsync { mapvinaMap: MapVinaMap -> initMap(mapvinaMap) }
