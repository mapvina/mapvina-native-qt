...
class QueryRenderedFeaturesBoxCountActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { mapvinaMap: MapVinaMap ->
            this@QueryRenderedFeaturesBoxCountActivity.mapvinaMap = mapvinaMap
            ...
            selectionBox.setOnClickListener { _: View? ->
                ...
                val features = mapvinaMap.queryRenderedFeatures(box)
    ...
    override fun onStart() {
        ...
        if (::mapvinaMap.isInitialized) {
            ...
            mapvinaMap.queryRenderedFeatures(PointF(0F, 0F))
        }
    }
