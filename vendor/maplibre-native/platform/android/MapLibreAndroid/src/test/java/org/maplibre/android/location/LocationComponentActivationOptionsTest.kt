    ...
    fun setUp() {
        Mockito.`when`(
            context!!.obtainStyledAttributes(
                R.style.mapvina_LocationComponent,
                R.styleable.mapvina_LocationComponent
            )
        )
            .thenReturn(array)
        Mockito.`when`(
            array!!.getResourceId(
                R.styleable.mapvina_LocationComponent_mapvina_foregroundDrawable,
                -1
            )
        )
            .thenReturn(R.drawable.mapvina_user_icon)
