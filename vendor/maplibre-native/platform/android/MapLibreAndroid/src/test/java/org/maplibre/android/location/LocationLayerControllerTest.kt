...
class LocationLayerControllerTest {
    private val mapvinaMap = Mockito.mock(MapVinaMap::class.java)
    ...
    @Before
    fun before() {
        Mockito.`when`(mapvinaMap.style).thenReturn(style)
    }
    ...
    fun onInitialization_numberOfCachedLayerIdsIsConstant() {
        ...
        controller.initializeComponents(mapvinaMap.style, options)
    ...
    fun onNewLatLngValue_locationFeatureIsUpdated() {
        ...
        getAnimationListener<Any>(
            MapVinaAnimator.ANIMATOR_LAYER_LATLNG,
    ...
    fun onNewGpsBearingValue_locationFeatureIsUpdated() {
        ...
        val gpsBearing = 2f
        getAnimationListener<Any>(
            MapVinaAnimator.ANIMATOR_LAYER_GPS_BEARING,
            layer.animationListeners
    ...
    fun onNewCompassBearingValue_locationFeatureIsUpdated() {
        ...
        getAnimationListener<Any>(
            MapVinaAnimator.ANIMATOR_LAYER_COMPASS_BEARING,
            layer.animationListeners
        )
    ...
    fun onNewAccuracyRadiusValue_locationFeatureIsUpdated() {
        ...
        getAnimationListener<Any>(MapVinaAnimator.ANIMATOR_LAYER_ACCURACY, layer.animationListeners)
    ...
    fun onNewAccuracyRadiusValue_updateIgnoredWithInvalidRenderMode() {
        ...
        Assert.assertNull(
            getAnimationListener<Any>(
                MapVinaAnimator.ANIMATOR_LAYER_ACCURACY,
                layer.animationListeners
            )
        )
        Mockito.verify(locationFeature, Mockito.times(0))
