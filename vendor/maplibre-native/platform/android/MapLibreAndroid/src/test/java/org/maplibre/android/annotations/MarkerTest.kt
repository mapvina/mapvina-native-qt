...
import com.mapvina.android.utils.MockParcel
...
class MarkerTest {
    ...
    @Test
    fun testTitle() {
        val markerOptions = MarkerOptions().title("MapVina").position(LatLng())
        val marker = markerOptions.marker
        Assert.assertEquals(marker.title, "MapVina")
        Assert.assertEquals(markerOptions.getTitle(), "MapVina")
    }

    @Test
    fun testSnippet() {
        val markerOptions = MarkerOptions().snippet("MapVina").position(LatLng())
        val marker = markerOptions.marker
        Assert.assertEquals(marker.snippet, "MapVina")
    }
