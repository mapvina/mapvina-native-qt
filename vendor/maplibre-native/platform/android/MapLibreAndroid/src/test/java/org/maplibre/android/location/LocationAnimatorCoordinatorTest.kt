...
import com.mapvina.android.location.LocationComponentConstants.DEFAULT_TRACKING_TILT_ANIM_DURATION
import com.mapvina.android.location.LocationComponentConstants.DEFAULT_TRACKING_ZOOM_ANIM_DURATION
import com.mapvina.android.location.MapVinaAnimator.*
...
import com.mapvina.android.location.LocationComponentConstants.DEFAULT_TRACKING_PADDING_ANIM_DURATION
import org.mockito.Mockito
import org.robolectric.RobolectricTestRunner
import com.mapvina.testUtils.Assert as MapVinaAssert
...
class LocationAnimatorCoordinatorTest {
    ...
    private val animatorProvider: MapVinaAnimatorProvider = mockk()
    private val animatorSetProvider: MapVinaAnimatorSetProvider = mockk()
    ...
    private fun configureAnimatorProvider() {
        ...
        every {
            ...
            MapVinaPaddingAnimator(doubleArraySlot.captured, doubleArrayListenerSlot.captured, callback.captured)
        }
        every {
            animatorProvider.paddingAnimator(capture(doubleArraySlot), capture(doubleArrayListenerSlot), null)
        } answers {
            MapVinaPaddingAnimator(doubleArraySlot.captured, doubleArrayListenerSlot.captured, null)
        }
    }
    ...
    fun feedNewLocation_animatorValue() {
        ...
        MapVinaAssert.assertEquals(location.latitude, cameraLatLngTarget.latitude)
        MapVinaAssert.assertEquals(location.longitude, cameraLatLngTarget.longitude)

        val layerLatLngTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_LATLNG]?.target as LatLng
        MapVinaAssert.assertEquals(location.latitude, layerLatLngTarget.latitude)
        MapVinaAssert.assertEquals(location.longitude, layerLatLngTarget.longitude)

        val cameraBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_CAMERA_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(location.bearing, cameraBearingTarget)

        val layerBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(location.bearing, layerBearingTarget)
    }
    ...
    fun feedNewLocation_animatorValue_correctRotation_1() {
        ...
        val animator = mockk<MapVinaFloatAnimator>(relaxed = true)
        ...
        val layerBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(360f, layerBearingTarget)
    }
    ...
    fun feedNewLocation_animatorValue_correctRotation_2() {
        ...
        val layerBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(450f, layerBearingTarget)
    }
    ...
    fun feedNewLocation_animatorValue_correctRotation_3() {
        ...
        val layerBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(-60f, layerBearingTarget)
    }
    ...
    fun feedNewLocation_animatorValue_correctRotation_4() {
        ...
        val layerBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(-10f, layerBearingTarget)
    }
    ...
    fun feedNewLocation_animatorValue_correctRotation_5() {
        ...
        val layerBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(90f, layerBearingTarget)
    }
    ...
    fun feedNewLocation_isNorth_animatorValue() {
        ...
        val cameraLatLngTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_CAMERA_LATLNG]?.target as LatLng
        MapVinaAssert.assertEquals(cameraLatLngTarget.latitude, cameraLatLngTarget.latitude)

        val layerLatLngTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_LAYER_LATLNG]?.target as LatLng
        MapVinaAssert.assertEquals(layerLatLngTarget.latitude, layerLatLngTarget.latitude)

        val cameraBearingTarget = locationAnimatorCoordinator.animatorArray[ANIMATOR_CAMERA_GPS_BEARING]?.target as Float
        MapVinaAssert.assertEquals(0f, cameraBearingTarget)
    ...
    fun feedNewAccuracyRadius_animatorValue() {
        ...
        MapVinaAssert.assertEquals(layerAccuracy, accuracy)
    }
    ...
    fun feedNewZoomLevel_animatorValue() {
        ...
        MapVinaAssert.assertEquals(zoom, animator.target as Float)
    ...
    fun feedNewTiltLevel_animatorValue() {
        ...
        MapVinaAssert.assertEquals(tilt, animator.target as Float)
    ...
    // regression test for crash https://github.com/mapvina/mapvina-native/issues/3294
    @Test
