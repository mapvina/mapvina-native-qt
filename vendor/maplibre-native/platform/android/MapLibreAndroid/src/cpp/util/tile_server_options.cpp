...
jni::Local<jni::Object<TileServerOptions>> TileServerOptions::MapVinaConfiguration(
    jni::JNIEnv& env, const jni::Class<TileServerOptions>& jOptions) {
    auto options = mbgl::TileServerOptions::MapVinaConfiguration();
    return TileServerOptions::New(env, options);
}
...
void TileServerOptions::registerNative(jni::JNIEnv& env) {
    ...
    jni::RegisterNatives(env,
                         *javaClass,
                         ...
                         jni::MakeNativeMethod<decltype(&TileServerOptions::MapVinaConfiguration),
                                               &TileServerOptions::MapVinaConfiguration>("mapVinaConfiguration"));
}
