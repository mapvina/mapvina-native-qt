package com.mapvina.android.util;
...
public class TileServerOptions implements Parcelable {
   ...
   * @param uriSchemeAlias       scheme alias such as mapvina://
  ...
  public static TileServerOptions get(WellKnownTileServer tileServer) {
    switch (tileServer) {
      ...
      default:
        throw new MapVinaConfigurationException("Unknown tile server");
    }
  }
  ...
  @Keep
  @NonNull
  private static native TileServerOptions mapVinaConfiguration();
}
