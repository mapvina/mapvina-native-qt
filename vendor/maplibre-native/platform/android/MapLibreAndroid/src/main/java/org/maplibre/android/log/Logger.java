...
/**
 * Logger for the MapVina Maps SDK for Android
 * <p>
...
public final class Logger {
  ...
  /**
   * Log level indicates which logs are allowed to be emitted by the MapVina Maps SDK for Android.
   */
