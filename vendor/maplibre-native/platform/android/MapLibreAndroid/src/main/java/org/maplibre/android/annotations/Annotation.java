...
public abstract class Annotation implements Comparable<Annotation> {
  ...
  public void remove() {
    ...
    mapvinaMap.removeAnnotation(this);
  }
   ...
   */
  public void setMapVinaMap(MapVinaMap mapvinaMap) {
    this.mapvinaMap = mapvinaMap;
  }

  /**
   * Gets the hosting MapVinaMap.
   *
   * @return the MapVinaMap
   */
  protected MapVinaMap getMapVinaMap() {
    return mapvinaMap;
  }
