...
import static com.mapvina.android.location.LocationComponentConstants.ACCURACY_LAYER;
import static com.mapvina.android.location.LocationComponentConstants.BACKGROUND_ICON;
import static com.mapvina.android.location.LocationComponentConstants.BACKGROUND_LAYER;
import static com.mapvina.android.location.LocationComponentConstants.BACKGROUND_STALE_ICON;
import static com.mapvina.android.location.LocationComponentConstants.BEARING_ICON;
import static com.mapvina.android.location.LocationComponentConstants.BEARING_LAYER;
import static com.mapvina.android.location.LocationComponentConstants.FOREGROUND_ICON;
import static com.mapvina.android.location.LocationComponentConstants.FOREGROUND_LAYER;
import static com.mapvina.android.location.LocationComponentConstants.FOREGROUND_STALE_ICON;
import static com.mapvina.android.location.LocationComponentConstants.LOCATION_SOURCE;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_ACCURACY_ALPHA;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_ACCURACY_COLOR;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_ACCURACY_RADIUS;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_BACKGROUND_ICON;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_BACKGROUND_STALE_ICON;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_BEARING_ICON;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_COMPASS_BEARING;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_FOREGROUND_ICON;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_FOREGROUND_ICON_OFFSET;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_FOREGROUND_STALE_ICON;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_GPS_BEARING;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_LOCATION_STALE;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_PULSING_OPACITY;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_PULSING_RADIUS;
import static com.mapvina.android.location.LocationComponentConstants.PROPERTY_SHADOW_ICON_OFFSET;
import static com.mapvina.android.location.LocationComponentConstants.PULSING_CIRCLE_LAYER;
import static com.mapvina.android.location.LocationComponentConstants.SHADOW_ICON;
import static com.mapvina.android.location.LocationComponentConstants.SHADOW_LAYER;
...
import static com.mapvina.android.style.layers.PropertyFactory.circleOpacity;
import static com.mapvina.android.style.layers.PropertyFactory.circleRadius;
import static com.mapvina.android.style.layers.PropertyFactory.circleStrokeColor;
import static com.mapvina.android.style.layers.PropertyFactory.iconSize;
import static com.mapvina.android.style.layers.PropertyFactory.visibility;
import static com.mapvina.android.utils.ColorUtils.colorToRgbaString;
...
final class SymbolLocationLayerRenderer implements LocationLayerRenderer {
  ...
  private void refreshSource() {
    ...
    // https://github.com/mapvina/mapvina-native/issues/3348
    if (!style.isFullyLoaded()) {
      return;
    }
