...
import com.mapvina.android.exceptions.ConversionException;
...
public class ColorUtils {
  ...
  public static int getPrimaryColor(@NonNull Context context) {
    try {
      ...
      return getColorCompat(context, R.color.mapvina_blue);
    }
  }
  ...
  public static int getAccentColor(@NonNull Context context) {
    try {
      ...
      return getColorCompat(context, R.color.mapvina_gray);
    }
  }
