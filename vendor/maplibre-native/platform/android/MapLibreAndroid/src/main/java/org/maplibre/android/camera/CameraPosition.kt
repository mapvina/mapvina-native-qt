...
import com.mapvina.android.camera.CameraPosition.Builder
import com.mapvina.android.camera.CameraUpdateFactory.CameraPositionUpdate
import com.mapvina.android.camera.CameraUpdateFactory.ZoomUpdate
 ...
 */ @Keep internal constructor(
    ...
    class Builder {
        ...
        constructor(typedArray: TypedArray?) : super() {
            if (typedArray != null) {
                bearing = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraBearing, 0.0f).toDouble()
                val lat = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraTargetLat, 0.0f).toDouble()
                val lng = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraTargetLng, 0.0f).toDouble()
                target = LatLng(lat, lng)
                tilt = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraTilt, 0.0f).toDouble()
                zoom = typedArray.getFloat(R.styleable.mapvina_MapView_mapvina_cameraZoom, 0.0f).toDouble()
            }
        }
         ...
         *
         *
         * value is clamped to [MapVinaConstants.MINIMUM_TILT] and [MapVinaConstants.MAXIMUM_TILT].
         *
         *
         * @param tilt Tilt value of the camera
         * @return this
         */
        fun tilt(@FloatRange(from = MapVinaConstants.MINIMUM_TILT, to = MapVinaConstants.MAXIMUM_TILT) tilt: Double): Builder {
            this.tilt = MathUtils.clamp(tilt, MapVinaConstants.MINIMUM_TILT, MapVinaConstants.MAXIMUM_TILT)
            return this
        }
         ...
         *
         *
         * Zoom ranges from [MapVinaConstants.MINIMUM_ZOOM] to [MapVinaConstants.MAXIMUM_ZOOM]
         *
         *
         * @param zoom Zoom value of the camera
         * @return this
         */
        fun zoom(@FloatRange(from = MapVinaConstants.MINIMUM_ZOOM.toDouble(), to = MapVinaConstants.MAXIMUM_ZOOM.toDouble()) zoom: Double): Builder {
            this.zoom = zoom
            return this
        }
