 ...
 */
public abstract class MapVinaAnimator<K> extends ValueAnimator implements ValueAnimator.AnimatorUpdateListener {
  ...
  public MapVinaAnimator(@NonNull @Size(min = 2) K[] values, @NonNull AnimationsValueChangeListener<K> updateListener,
                   int maxAnimationFps) {
  ...
  public MapVinaAnimator(AnimationsValueChangeListener<K> updateListener, K target, K animatedValue,
