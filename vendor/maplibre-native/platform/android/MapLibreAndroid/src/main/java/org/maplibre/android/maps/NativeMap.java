...
interface NativeMap {
  ...
  void setOnFpsChangedListener(@NonNull MapVinaMap.OnFpsChangedListener listener);
  ...
  void addSnapshotCallback(@NonNull MapVinaMap.SnapshotReadyCallback callback);
}
