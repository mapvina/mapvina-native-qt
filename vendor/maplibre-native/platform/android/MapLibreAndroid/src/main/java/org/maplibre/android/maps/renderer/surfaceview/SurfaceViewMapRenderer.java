 ...
 * {@link MapVinaSurfaceView} specifics to render the map.
 *
 * @see MapRenderer
 */
public class SurfaceViewMapRenderer extends MapRenderer {
  ...
  @NonNull
  protected final MapVinaSurfaceView surfaceView;

  public SurfaceViewMapRenderer(Context context,
                                MapVinaSurfaceView surfaceView,
                                String localIdeographFontFamily) {
    super(context, localIdeographFontFamily);
    this.surfaceView = surfaceView;

    surfaceView.setDetachedListener(new MapVinaSurfaceView.OnSurfaceViewDetachedListener() {
      @Override
