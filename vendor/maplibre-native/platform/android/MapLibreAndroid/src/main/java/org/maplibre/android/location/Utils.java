...
import static com.mapvina.android.location.LocationComponentConstants.INSTANT_LOCATION_TRANSITION_THRESHOLD;
...
public final class Utils {
  ...
  static float calculateZoomLevelRadius(@NonNull MapVinaMap mapvinaMap, @Nullable Location location) {
    if (location == null) {
      return 0;
    }
    double metersPerPixel = mapvinaMap.getProjection().getMetersPerPixelAtLatitude(location.getLatitude());
