...
import com.mapvina.android.utils.MapFragmentUtils;
...
public final class MapFragment extends Fragment implements OnMapReadyCallback {
   ...
   *
   * @param mapvinaMapOptions The configuration options to be used.
   * @return MapFragment instantiated.
   */
  @NonNull
  public static MapFragment newInstance(@Nullable MapVinaMapOptions mapvinaMapOptions) {
    MapFragment mapFragment = new MapFragment();
    mapFragment.setArguments(MapFragmentUtils.createFragmentArgs(mapvinaMapOptions));
    return mapFragment;
  }
  ...
  public void onInflate(@NonNull Context context, AttributeSet attrs, Bundle savedInstanceState) {
    ...
    setArguments(MapFragmentUtils.createFragmentArgs(MapVinaMapOptions.createFromAttributes(context, attrs)));
  }
   ...
   *
   * @param mapvinaMap The public api controller of the map
   */
  @Override
  public void onMapReady(@NonNull MapVinaMap mapvinaMap) {
    ...
    for (OnMapReadyCallback onMapReadyCallback : mapReadyCallbackList) {
      onMapReadyCallback.onMapReady(mapvinaMap);
    }
  }
  ...
  /**
   * Sets a callback object which will be triggered when the MapVinaMap instance is ready to be used.
   *
