...
import com.mapvina.android.maps.widgets.CompassView;
import com.mapvina.android.utils.BitmapUtils;
import com.mapvina.android.utils.ColorUtils;

/**
 * Settings for the user interface of a MapVinaMap. To obtain this interface, call getUiSettings().
 */
public final class UiSettings {
  ...
  private long flingAnimationBaseTime = MapVinaConstants.ANIMATION_DURATION_FLING_BASE;
  private long flingThreshold = MapVinaConstants.VELOCITY_THRESHOLD_IGNORE_FLING;
  ...
  private void initialiseGestures(MapVinaMapOptions options) {
  ...
  private void saveGestures(Bundle outState) {
    outState.putBoolean(MapVinaConstants.STATE_HORIZONAL_SCROLL_ENABLED, isHorizontalScrollGesturesEnabled());
    outState.putBoolean(MapVinaConstants.STATE_ZOOM_ENABLED, isZoomGesturesEnabled());
    outState.putBoolean(MapVinaConstants.STATE_SCROLL_ENABLED, isScrollGesturesEnabled());
    outState.putBoolean(MapVinaConstants.STATE_ROTATE_ENABLED, isRotateGesturesEnabled());
    outState.putBoolean(MapVinaConstants.STATE_TILT_ENABLED, isTiltGesturesEnabled());
    outState.putBoolean(MapVinaConstants.STATE_DOUBLE_TAP_ENABLED, isDoubleTapGesturesEnabled());
    outState.putBoolean(MapVinaConstants.STATE_SCALE_ANIMATION_ENABLED, isScaleVelocityAnimationEnabled());
    outState.putBoolean(MapVinaConstants.STATE_ROTATE_ANIMATION_ENABLED, isRotateVelocityAnimationEnabled());
    outState.putBoolean(MapVinaConstants.STATE_FLING_ANIMATION_ENABLED, isFlingVelocityAnimationEnabled());
    outState.putBoolean(MapVinaConstants.STATE_INCREASE_ROTATE_THRESHOLD, isIncreaseRotateThresholdWhenScaling());
    outState.putBoolean(MapVinaConstants.STATE_DISABLE_ROTATE_WHEN_SCALING, isDisableRotateWhenScaling());
    outState.putBoolean(MapVinaConstants.STATE_INCREASE_SCALE_THRESHOLD, isIncreaseScaleThresholdWhenRotating());
    outState.putBoolean(MapVinaConstants.STATE_QUICK_ZOOM_ENABLED, isQuickZoomGesturesEnabled());
    outState.putFloat(MapVinaConstants.STATE_ZOOM_RATE, getZoomRate());
  }

  private void restoreGestures(Bundle savedInstanceState) {
    setHorizontalScrollGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_HORIZONAL_SCROLL_ENABLED));
    setZoomGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_ZOOM_ENABLED));
    setScrollGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_SCROLL_ENABLED));
    setRotateGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_ROTATE_ENABLED));
    setTiltGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_TILT_ENABLED));
    setDoubleTapGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_DOUBLE_TAP_ENABLED));
    setScaleVelocityAnimationEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_SCALE_ANIMATION_ENABLED));
    setRotateVelocityAnimationEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_ROTATE_ANIMATION_ENABLED));
    setFlingVelocityAnimationEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_FLING_ANIMATION_ENABLED));
    setIncreaseRotateThresholdWhenScaling(
      savedInstanceState.getBoolean(MapVinaConstants.STATE_INCREASE_ROTATE_THRESHOLD));
    setDisableRotateWhenScaling(savedInstanceState.getBoolean(MapVinaConstants.STATE_DISABLE_ROTATE_WHEN_SCALING));
    setIncreaseScaleThresholdWhenRotating(
      savedInstanceState.getBoolean(MapVinaConstants.STATE_INCREASE_SCALE_THRESHOLD));
    setQuickZoomGesturesEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_QUICK_ZOOM_ENABLED));
    setZoomRate(savedInstanceState.getFloat(MapVinaConstants.STATE_ZOOM_RATE, 1.0f));
  }

  private void initialiseCompass(MapVinaMapOptions options, @NonNull Resources resources) {
    ...
    if (compassMargins != null) {
      ...
      int tenDp = (int) resources.getDimension(R.dimen.mapvina_four_dp);
    ...
    if (options.getCompassImage() == null) {
      options.compassImage(ResourcesCompat.getDrawable(resources, R.drawable.mapvina_compass_icon, null));
    }
    setCompassImage(options.getCompassImage());
  }

  private void saveCompass(Bundle outState) {
    outState.putBoolean(MapVinaConstants.STATE_COMPASS_ENABLED, isCompassEnabled());
    outState.putInt(MapVinaConstants.STATE_COMPASS_GRAVITY, getCompassGravity());
    outState.putInt(MapVinaConstants.STATE_COMPASS_MARGIN_LEFT, getCompassMarginLeft());
    outState.putInt(MapVinaConstants.STATE_COMPASS_MARGIN_TOP, getCompassMarginTop());
    outState.putInt(MapVinaConstants.STATE_COMPASS_MARGIN_BOTTOM, getCompassMarginBottom());
    outState.putInt(MapVinaConstants.STATE_COMPASS_MARGIN_RIGHT, getCompassMarginRight());
    outState.putBoolean(MapVinaConstants.STATE_COMPASS_FADE_WHEN_FACING_NORTH, isCompassFadeWhenFacingNorth());
    outState.putByteArray(MapVinaConstants.STATE_COMPASS_IMAGE_BITMAP,
      BitmapUtils.getByteArrayFromDrawable(getCompassImage()));
  }

  private void restoreCompass(Bundle savedInstanceState) {
    boolean compassEnabled = savedInstanceState.getBoolean(MapVinaConstants.STATE_COMPASS_ENABLED);
    if (compassEnabled && !isCompassInitialized) {
      compassView = mapView.initialiseCompassView();
      isCompassInitialized = true;
    }
    setCompassEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_COMPASS_ENABLED));
    setCompassGravity(savedInstanceState.getInt(MapVinaConstants.STATE_COMPASS_GRAVITY));
    setCompassMargins(savedInstanceState.getInt(MapVinaConstants.STATE_COMPASS_MARGIN_LEFT),
      savedInstanceState.getInt(MapVinaConstants.STATE_COMPASS_MARGIN_TOP),
      savedInstanceState.getInt(MapVinaConstants.STATE_COMPASS_MARGIN_RIGHT),
      savedInstanceState.getInt(MapVinaConstants.STATE_COMPASS_MARGIN_BOTTOM));
    setCompassFadeFacingNorth(savedInstanceState.getBoolean(MapVinaConstants.STATE_COMPASS_FADE_WHEN_FACING_NORTH));
    setCompassImage(BitmapUtils.getDrawableFromByteArray(
      mapView.getContext(), savedInstanceState.getByteArray(MapVinaConstants.STATE_COMPASS_IMAGE_BITMAP)));
  }

  private void initialiseLogo(MapVinaMapOptions options, @NonNull Resources resources) {
  ...
  private void setLogoMargins(@NonNull Resources resources, @Nullable int[] logoMargins) {
    if (logoMargins != null) {
      ...
      int fourDp = (int) resources.getDimension(R.dimen.mapvina_four_dp);
      setLogoMargins(fourDp, fourDp, fourDp, fourDp);
    }
  }

  private void saveLogo(Bundle outState) {
    outState.putInt(MapVinaConstants.STATE_LOGO_GRAVITY, getLogoGravity());
    outState.putInt(MapVinaConstants.STATE_LOGO_MARGIN_LEFT, getLogoMarginLeft());
    outState.putInt(MapVinaConstants.STATE_LOGO_MARGIN_TOP, getLogoMarginTop());
    outState.putInt(MapVinaConstants.STATE_LOGO_MARGIN_RIGHT, getLogoMarginRight());
    outState.putInt(MapVinaConstants.STATE_LOGO_MARGIN_BOTTOM, getLogoMarginBottom());
    outState.putBoolean(MapVinaConstants.STATE_LOGO_ENABLED, isLogoEnabled());
  }

  private void restoreLogo(Bundle savedInstanceState) {
    boolean logoEnabled = savedInstanceState.getBoolean(MapVinaConstants.STATE_LOGO_ENABLED);
    if (logoEnabled && !isLogoInitialized) {
      logoView = mapView.initialiseLogoView();
      isLogoInitialized = true;
    }
    setLogoEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_LOGO_ENABLED));
    setLogoGravity(savedInstanceState.getInt(MapVinaConstants.STATE_LOGO_GRAVITY));
    setLogoMargins(savedInstanceState.getInt(MapVinaConstants.STATE_LOGO_MARGIN_LEFT),
      savedInstanceState.getInt(MapVinaConstants.STATE_LOGO_MARGIN_TOP),
      savedInstanceState.getInt(MapVinaConstants.STATE_LOGO_MARGIN_RIGHT),
      savedInstanceState.getInt(MapVinaConstants.STATE_LOGO_MARGIN_BOTTOM));
  }

  private void initialiseAttribution(@NonNull Context context, MapVinaMapOptions options) {
  ...
  private void setAttributionMargins(@NonNull Context context, @Nullable int[] attributionMargins) {
    if (attributionMargins != null) {
      ...
      // user did not specify margins when programmatically creating a map
      Resources resources = context.getResources();
      int margin = (int) resources.getDimension(R.dimen.mapvina_four_dp);
      int leftMargin = (int) resources.getDimension(R.dimen.mapvina_ninety_two_dp);
      setAttributionMargins(leftMargin, margin, margin, margin);
    }
  }

  private void saveAttribution(Bundle outState) {
    outState.putInt(MapVinaConstants.STATE_ATTRIBUTION_GRAVITY, getAttributionGravity());
    outState.putInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_LEFT, getAttributionMarginLeft());
    outState.putInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_TOP, getAttributionMarginTop());
    outState.putInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_RIGHT, getAttributionMarginRight());
    outState.putInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_BOTTOM, getAttributionMarginBottom());
    outState.putBoolean(MapVinaConstants.STATE_ATTRIBUTION_ENABLED, isAttributionEnabled());
  }

  private void restoreAttribution(Bundle savedInstanceState) {
    boolean attributionEnabled = savedInstanceState.getBoolean(MapVinaConstants.STATE_ATTRIBUTION_ENABLED);
    if (attributionEnabled && !isAttributionInitialized) {
      attributionsView = mapView.initialiseAttributionView();
      isAttributionInitialized = true;
    }
    setAttributionEnabled(savedInstanceState.getBoolean(MapVinaConstants.STATE_ATTRIBUTION_ENABLED));
    setAttributionGravity(savedInstanceState.getInt(MapVinaConstants.STATE_ATTRIBUTION_GRAVITY));
    setAttributionMargins(savedInstanceState.getInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_LEFT),
      savedInstanceState.getInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_TOP),
      savedInstanceState.getInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_RIGHT),
      savedInstanceState.getInt(MapVinaConstants.STATE_ATTRIBUTION_MARGIN_BOTTOM));
  }
  ...
  public void setCompassEnabled(boolean compassEnabled) {
    if (compassEnabled && !isCompassInitialized) {
      initialiseCompass(mapView.mapvinaMapOptions, mapView.getContext().getResources());
    }
    if (compassView != null) {
  ...
  /**
   * <p>
   * Enables or disables the MapVina logo.
   * </p>
  ...
  public void setLogoEnabled(boolean enabled) {
    if (enabled && !isLogoInitialized) {
      initialiseLogo(mapView.mapvinaMapOptions, mapView.getContext().getResources());
    }
    if (logoView != null) {
  ...
  /**
   * Sets the margins of the logo view in pixels. Use this to change the distance of the MapVina logo from the
   * map view edge.
   *
   * @param left   The left margin in pixels.
   * @param top    The top margin in pixels.
  ...
  public void setAttributionEnabled(boolean enabled) {
    if (enabled && !isAttributionInitialized) {
      initialiseAttribution(mapView.getContext(), mapView.mapvinaMapOptions);
    }
   ...
   * </p>
   * By default, the attribution is in the bottom left corner next to the MapVina logo.
   *
   * @param gravity Android SDK Gravity.
   */
  ...
  public void setAttributionTintColor(@ColorInt int tintColor) {
    ...
    if (Color.alpha(tintColor) == 0) {
      ColorUtils.setTintList(attributionsView,
        ContextCompat.getColor(attributionsView.getContext(), R.color.mapvina_blue));
    } else {
  ...
  private void restoreDeselectMarkersOnTap(Bundle savedInstanceState) {
    setDeselectMarkersOnTap(savedInstanceState.getBoolean(MapVinaConstants.STATE_DESELECT_MARKER_ON_TAP));
  }

  private void saveDeselectMarkersOnTap(Bundle outState) {
    outState.putBoolean(MapVinaConstants.STATE_DESELECT_MARKER_ON_TAP, isDeselectMarkersOnTap());
  }
  ...
  private void saveFocalPoint(Bundle outState) {
    outState.putParcelable(MapVinaConstants.STATE_USER_FOCAL_POINT, getFocalPoint());
  }

  private void restoreFocalPoint(Bundle savedInstanceState) {
    PointF pointF = savedInstanceState.getParcelable(MapVinaConstants.STATE_USER_FOCAL_POINT);
    if (pointF != null) {
