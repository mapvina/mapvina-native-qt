package com.mapvina.android.http;
...
public class HttpRequestUrl {
   ...
   * MapVina resources downloaded for offline use are subject to separate Vector Tile and
  ...
  /**
   * Validates if the host used as endpoint is a valid MapVina endpoint.
   *
   * @param host the host used as endpoint
   * @return true if a valid MapVina endpoint
   */
