...
public class LocationComponentOptions implements Parcelable {
   ...
   * the first parameter of {@link com.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   ...
   * and the custom {@link com.mapvina.android.gestures.AndroidGesturesManager} that was set with
   ...
   * {@link com.mapvina.android.maps.Style#addLayerAbove(Layer, String)}.
   * <p>
  ...
  /**
   * Gets the id of the layer that's referenced when placing the component on the map using
   * {@link com.mapvina.android.maps.Style#addLayerBelow(Layer, String)}.
   * <p>
  ...
  /**
   * Enable or disable smooth animation of compass values for {@link com.mapvina.android.location.modes.CameraMode}
   * and {@link com.mapvina.android.location.modes.RenderMode}.
   *
  ...
  public static class Builder {
     ...
     * @deprecated Use
     * {@link com.mapvina.android.camera.CameraPosition.Builder#padding(double, double, double, double)} or
     * {@link com.mapvina.android.camera.CameraUpdateFactory#paddingTo(double, double, double, double)}
     * instead.
     */
    @NonNull
    @Deprecated
