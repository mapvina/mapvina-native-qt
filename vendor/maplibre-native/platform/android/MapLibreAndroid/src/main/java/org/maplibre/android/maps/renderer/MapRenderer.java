...
public abstract class MapRenderer implements MapRendererScheduler {
  ...
  public static MapRenderer create(MapVinaMapOptions options, @NonNull Context context, Runnable initCallback) {
  ...
  public void setOnFpsChangedListener(MapVinaMap.OnFpsChangedListener listener) {
