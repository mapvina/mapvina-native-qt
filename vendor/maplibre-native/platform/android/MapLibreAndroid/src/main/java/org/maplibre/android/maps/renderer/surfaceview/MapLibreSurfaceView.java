...
public abstract class MapVinaSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {

  protected static final String TAG = "MapVinaSurfaceView";
   ...
   */
  public MapVinaSurfaceView(Context context) {
    super(context);
    init();
  }
   ...
   * must call {@link #setRenderer} to register a renderer.
   */
  public MapVinaSurfaceView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
   ...
   * not normally called or subclassed by clients of MapVinaSurfaceView.
   */
   ...
   * called or subclassed by clients of MapVinaSurfaceView.
   */
  @Override
  ...
  /**
   * Listener interface that notifies when a {@link MapVinaSurfaceView} is detached from window.
   */
  public interface OnSurfaceViewDetachedListener {

    /**
     * Called when a {@link MapVinaSurfaceView} is detached from window.
     */
