package com.mapvina.android.module.http;
...
import com.mapvina.android.http.HttpIdentifier;
import com.mapvina.android.http.HttpLogger;
import com.mapvina.android.http.HttpRequest;
import com.mapvina.android.http.HttpRequestUrl;
import com.mapvina.android.http.HttpResponder;
...
import static com.mapvina.android.module.http.HttpRequestUtil.toHumanReadableAscii;
...
public class HttpRequestImpl implements HttpRequest {
  ...
  private static final String userAgentString = toHumanReadableAscii(
    String.format("%s %s (%s) Android/%s (%s)",
      ...
      BuildConfig.MAPVINA_VERSION_STRING,
  ...
  public void executeRequest(HttpResponder httpRequest, long nativePtr, @NonNull String resourceUrl,
    ...
    try {
      ...
      final String host = httpUrl.host().toLowerCase(MapVinaConstants.MAPVINA_LOCALE);
      resourceUrl = HttpRequestUrl.buildResourceUrl(host, resourceUrl, httpUrl.querySize(), offlineUsage);

      final Request.Builder builder = new Request.Builder()
        .url(resourceUrl)
        .tag(resourceUrl.toLowerCase(MapVinaConstants.MAPVINA_LOCALE))
