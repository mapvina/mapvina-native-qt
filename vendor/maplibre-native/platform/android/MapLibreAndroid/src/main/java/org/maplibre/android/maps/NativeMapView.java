...
import com.mapvina.android.exceptions.CalledFromWorkerThreadException;
import com.mapvina.android.geometry.LatLng;
import com.mapvina.android.geometry.LatLngBounds;
import com.mapvina.android.geometry.ProjectedMeters;
...
import com.mapvina.android.tile.TileOperation;
...
final class NativeMapView implements NativeMap {
  ...
  private MapVinaMap.SnapshotReadyCallback snapshotReadyCallback;
  ...
  public NativeMapView(@NonNull final Context context, final MapVinaMapOptions options,
                       final ViewCallback viewCallback, final StateCallback stateCallback,
                       final MapRenderer mapRenderer) {
  ...
  @Override
  public void addSnapshotCallback(@NonNull MapVinaMap.SnapshotReadyCallback callback) {
  ...
  @Override
  public void setOnFpsChangedListener(@Nullable final MapVinaMap.OnFpsChangedListener listener) {
    ...
    mapRenderer.queueEvent(new Runnable() {
      ...
      public void run() {
        if (listener != null) {
          mapRenderer.setOnFpsChangedListener(new MapVinaMap.OnFpsChangedListener() {
            @Override
