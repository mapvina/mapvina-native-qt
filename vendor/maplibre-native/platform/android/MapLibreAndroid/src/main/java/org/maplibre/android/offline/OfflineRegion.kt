 ...
 * Use [com.mapvina.android.offline.OfflineManager.CreateOfflineRegionCallback]
...
class OfflineRegion @Keep private constructor(offlineRegionPtr: Long, fileSource: FileSource, idParam: Long, definition: OfflineRegionDefinition, metadata: ByteArray) {
   ...
   */
    ...
    interface OfflineRegionObserver {
        ...
        /*
     * Implement this method to be notified when the limit on the number of MapVina
     ...
     * tiles from MapVina APIs until existing tiles have been removed.
     *
     * This limit does not apply to non-MapVina tile sources.
     *
     * This method will be executed on the main thread.
     */
     ...
     */
    init {
        context = MapVina.getApplicationContext()
    ...
    /**
     * Invalidate all the tiles from an offline region forcing MapVina GL to revalidate
