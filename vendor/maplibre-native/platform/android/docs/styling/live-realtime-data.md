...
--8<-- "MapVinaAndroidTestApp/src/main/java/org/mapvina/android/testapp/activity/style/RealTimeGeoJsonActivity.kt:addSource"
```

Next we will create a `SymbolLayer` that uses the source.

```kotlin title="Adding a SymbolLayer source"
--8<-- "MapVinaAndroidTestApp/src/main/java/org/mapvina/android/testapp/activity/style/RealTimeGeoJsonActivity.kt:addLayer"
```
...
--8<-- "MapVinaAndroidTestApp/src/main/java/org/mapvina/android/testapp/activity/style/RealTimeGeoJsonActivity.kt:Runnable"
```
...
```kotlin title="Defining a Runnable for updating the GeoJSON source"
--8<-- "MapVinaAndroidTestApp/src/main/java/org/mapvina/android/testapp/activity/style/RealTimeGeoJsonActivity.kt:setIconRotation"
```
