# MapVina Android Examples

Welcome to the examples documentation of MapVina Android.
...
-   :material-clock-fast:{ .lg .middle } __Quickstart__
    ...
    Learn how to include MapVina Android in your project
...
-   :fontawesome-brands-slack:{ .lg .middle } __Find us on Slack__
    ...
    Discuss the project and ask questions in the `#mapvina-android` channel
...
## Open-Source Apps Using MapVina Android

You can learn how to use the API from MapVina Android by stuying the source code of existing apps that intergrate MapVina Android. Here are some open-source apps that use MapVina Android:
