...
2. Add the library as a dependency into your module Gradle file (usually `<project>/<app-module>/build.gradle`). Replace `<version>` with the [latest MapVina Android version](https://github.com/mapvina/mapvina-native/releases?q=android-v11&expanded=true) (e.g.: `com.mapvina.gl:android-sdk:11.8.0`):

    ```gradle
    dependencies {
        ...
        implementation 'com.mapvina.gl:android-sdk:<version>'
