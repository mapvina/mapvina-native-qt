...
- **Move**: available via the `MapVinaMap.moveCamera` method.
- **Ease**: available via the `MapVinaMap.easeCamera` method.
- **Animate**: available via the `MapVinaMap.animateCamera` method.
...
The `MapVinaMap.animateCamera` uses a powered flight animation move to the camera position provided[^1].
