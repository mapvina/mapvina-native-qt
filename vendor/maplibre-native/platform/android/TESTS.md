...
* Choose the `MapVinaAndroidTestApp` module
...
* As folder, choose the following folder: `mapbox-gl-native/android/java/MapVinaAndroidTestApp/src/test/java`
* Click OK to save the new configuration

You can also run the tests from the command line with:

```
$ ./gradlew -Pmapvina.abis=none test -p MapVinaAndroidTestApp
```
