...
export appFile="MapVinaAndroidTestApp/build/outputs/apk/legacy/release/MapVinaAndroidTestApp-legacy-release.apk"
export testFile="MapVinaAndroidTestApp/build/outputs/apk/androidTest/legacy/release/MapVinaAndroidTestApp-legacy-release-androidTest.apk"
