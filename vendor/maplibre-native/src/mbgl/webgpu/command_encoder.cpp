...
CommandEncoder::CommandEncoder(Context& ctx)
    ...
    if (device) {
        ...
        WGPUStringView label = {"MapVina Command Encoder", strlen("MapVina Command Encoder")};
        desc.label = label;
...
void CommandEncoder::submitCommandBuffer() {
    ...
    WGPUCommandEncoderDescriptor desc = {};
    WGPUStringView encoderLabel = {"MapVina Command Encoder", strlen("MapVina Command Encoder")};
