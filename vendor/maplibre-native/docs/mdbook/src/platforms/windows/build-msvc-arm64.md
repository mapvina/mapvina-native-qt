# Build Windows ARM64 with MSCV for MapVina Native

This guide provides step-by-step instructions for building MapVina Native on Windows ARM64 systems.
...
```powershell
# Navigate to your mapvina-native directory
cd mapvina-native
...
You can build MapVina Native with either OpenGL or Vulkan renderer. The Vulkan renderer provides significantly better performance on ARM64 devices.
...
cmake -S . -B build-windows-arm64-opengl --preset windows-arm64-opengl -DCMAKE_PREFIX_PATH="C:/Users/$env:USERNAME/source/repos/mapvina-native-cleanup/platform/windows/vendor/vcpkg/installed/arm64-windows"
...
# IMPORTANT: You must explicitly set CMAKE_PREFIX_PATH for ARM64 builds
cmake -S . -B build-windows-arm64-vulkan --preset windows-arm64-vulkan -DCMAKE_PREFIX_PATH="C:/Users/$env:USERNAME/source/repos/mapvina-native-cleanup/platform/windows/vendor/vcpkg/installed/arm64-windows"
...
- `mbgl-core.lib` - The core MapVina library (~107 MB)
...
- Example: `-DCMAKE_PREFIX_PATH="C:/path/to/mapvina-native/platform/windows/vendor/vcpkg/installed/arm64-windows"`
