...
There are two iOS apps available in the repo that you can use for MapVina Native development. One Objective-C based app and a Swift based app.
...
This app is available as "MapVinaApp" in the [generated Xcode project](./README.md).
...
```
bazel run --//:renderer=metal //platform/ios/app-swift:MapVinaApp
```
