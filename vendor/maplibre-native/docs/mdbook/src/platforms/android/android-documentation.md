# Documentation for MapVina Android
...
Next, visit [`http://localhost:8000/mapvina-native/android/examples/`](http://localhost:8000/mapvina-native/android/examples/).
...
Static assets are ideally uploaded to the [MapVina Native S3 Bucket](https://mapvina-native.s3.eu-central-1.amazonaws.com/index.html#android-documentation-resources/).
