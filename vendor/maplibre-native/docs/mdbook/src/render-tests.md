...
To run the entire integration test suite (both render or query tests), from within the mapvina-native directory on Linux run the command:
...
13 passed (100.0%)
Results at: /Users/bart/src/mapvina-native/metrics/macos-xcode11-release-style.html
```
