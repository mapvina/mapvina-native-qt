...
type ExpiryData = {
  ...
  expires?: string | null; // MapVina can be a Date object
};

// copied from MapVina /util/ajax.ts
...
/**
 * MapVina GL JS protocol. Must be added once globally.
 */
export class Protocol {
  ...
  /**
   * Initialize the MapVina PMTiles protocol.
   *
   ...
   *
   * For remote fetch sources, references in MapVina styles like pmtiles://http://...
