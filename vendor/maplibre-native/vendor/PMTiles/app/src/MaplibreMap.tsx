...
import { MapGeoJSONFeature } from "mapvina-gl";
...
function MapvinaMap(props: { file: PMTiles; mapHashPassed: boolean }) {
  ...
  const mapRef = useRef<mapvinagl.Map | null>(null);
  ...
  useEffect(() => {
    ...
    map.addControl(new mapvinagl.NavigationControl({}), "bottom-left");
