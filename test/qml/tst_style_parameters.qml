...
Item {
    ...
    TestCase {
        ...
        function test_init() {
            ...
            wait(500)
            compare(radarSourceParam.url, "https://mapvina.com/mapvina-gl-js/docs/assets/radar1.gif")
        }
        ...
        function test_style_3_image_change() {
            radarSourceParam.url = "https://mapvina.com/mapvina-gl-js/docs/assets/radar2.gif"
            compare(radarSourceParam.url, "https://mapvina.com/mapvina-gl-js/docs/assets/radar2.gif")
            wait(250)
            radarSourceParam.url = "https://mapvina.com/mapvina-gl-js/docs/assets/radar3.gif"
            compare(radarSourceParam.url, "https://mapvina.com/mapvina-gl-js/docs/assets/radar3.gif")
            wait(250)
            radarSourceParam.url = "https://mapvina.com/mapvina-gl-js/docs/assets/radar4.gif"
            compare(radarSourceParam.url, "https://mapvina.com/mapvina-gl-js/docs/assets/radar4.gif")
            wait(250)
