...
Item {
    ...
    Plugin {
        ...
        PluginParameter {
            ...
            value: "https://maps.mapvina.com/styles/v2/streets.json?key=public_key,https://demotiles.mapvina.com/style2.json"
        }
        PluginParameter {
            name: "mapvina.cache.memory"
            value: true
        }
    }
